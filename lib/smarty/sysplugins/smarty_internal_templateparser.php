                ...
                do {
                    ...
                    if (isset(self::$yyExpectedTokens[$nextstate])) {
                        ...
                        if (isset($res4[$nextstate][$token])) {
                            ...
                            if ($res4[$nextstate][$token] = in_array(
                                $token,
            ...
            if ($yyact >= self::YYNSTATE && $yyact < self::YYNSTATE + self::YYNRULE) {
                ...
                do {
                    ...
                    if (isset($res2[$nextstate][$token])) {
                        ...
                        if ($res2[$nextstate][$token] = (isset(self::$yyExpectedTokens[$nextstate]) && in_array(
                                $token,
                                self::$yyExpectedTokens[$nextstate],
                                true
                            ))) {
...
// line 355 "../smarty/lexer/smarty_internal_templateparser.y"
    public function yy_r18()
    {
        $this->_retvalue = $this->compiler->compileTag(
            ...
            array('smarty_internal_index' => $this->yystack[$this->yyidx + -1]->minor['smarty_internal_index'])
        );
    }
...
// line 618 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    {
        $this->_retvalue = '$_smarty_tpl->getStreamVariable(\'' . substr(
                $this->yystack[$this->yyidx + -2]->minor,
                1
            ) . '://' . $this->yystack[$this->yyidx + 0]->minor . '\')';
    }
...
// line 623 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    {
        $this->_retvalue = $this->yystack[$this->yyidx + -2]->minor . trim(
                $this->yystack[$this->yyidx + -1]->minor
            ) . $this->yystack[$this->yyidx + 0]->minor;
    }
    ...
    public function yy_r94()
    {
        ...
        if ($this->yystack[$this->yyidx + -2]->minor['var'] === '\'smarty\'') {
            $this->compiler->appendPrefixCode(
                "<?php {$prefixVar} = " . $this->compiler->compileTag(
            ...
            $this->compiler->appendPrefixCode(
                "<?php  {$prefixVar} = " . $this->compiler->compileVariable(
                    $this->yystack[$this->yyidx + -2]->minor['var']
                ) . $this->yystack[$this->yyidx + -2]->minor['smarty_internal_index'] . ';?>'
            );
        }
...
// line 780 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    {
        if (!in_array(
                strtolower($this->yystack[$this->yyidx + -2]->minor),
                array('self', 'parent')
...
// line 813 "../smarty/lexer/smarty_internal_templateparser.y"
    public function yy_r103()
    {
        if ($this->yystack[$this->yyidx + 0]->minor['var'] === '\'smarty\'') {
            ...
            $this->_retvalue = $this->compiler->compileVariable(
                    $this->yystack[$this->yyidx + 0]->minor['var']
                ) . $this->yystack[$this->yyidx + 0]->minor['smarty_internal_index'];
        }
    }
...
// line 836 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    {
        $this->_retvalue = $this->compiler->compileConfigVariable(
            '\'' . $this->yystack[$this->yyidx + -1]->minor . '\''
        );
    }
...
// line 840 "../smarty/lexer/smarty_internal_templateparser.y"
    ...
    {
        $this->_retvalue = '(is_array($tmp = ' . $this->compiler->compileConfigVariable(
                '\'' . $this->yystack[$this->yyidx + -2]->minor . '\''
...
// line 968 "../smarty/lexer/smarty_internal_templateparser.y"
    public function yy_r135()
    {
        if ($this->yystack[$this->yyidx + -1]->minor['var'] === '\'smarty\'') {
            ...
            $this->_retvalue = $this->compiler->compileVariable(
                    $this->yystack[$this->yyidx + -1]->minor['var']
...
// line 1243 "../smarty/lexer/smarty_internal_templateparser.y"
    public function yy_r180()
    {
        $this->_retvalue = new Smarty_Internal_ParseTree_Code(
            '(string)(' . $this->yystack[$this->yyidx + -1]->minor . ')'
        );
    }
